...
if settings_json['debug']['mode'] == 'dev':
    ...
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True
    EMAIL_HOST_USER = 'AKIA37IB5JIVKISWB6FZ'
    EMAIL_HOST_PASSWORD = 'BLFU7Q+AWth8e4EyCPDO1h676YOMd0JcHFEwVeO1Q7dS'
    DEFAULT_FROM_EMAIL = 'admin@coronagram.com'
...
elif settings_json['debug']['mode'] == 'admin':
    # debug True
    # SECURITY WARNING: keep the secret key used in production secret!
